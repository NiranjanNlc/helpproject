...
export function renderValue(state, val) {
    return (
          state.title.indexOf(val.toLowerCase())!== -1

        //  toLowerCase.indexOf(val.toLowerCase())!== -1
         // ValueData.title.toLowerCase.indexOf(val.toLowerCase())!== -1
    //   title.toLowerCase().indexOf(val.toLowerCase()) !== -1
    );
}
