                        ...
                        <div className="row justify-content-center">
                            <div className="col-sm-12">
                                <article>
                                    ...
                                    <p>Any requests to exercise User rights can be directed to Mobile Application Developer through the contact details provided in this document. These requests can be exercised free of charge and will be addressed by Mobile Application Developer as early as possible.</p>
                                    ...
                                    <h2>Contacting us</h2>
                                    <p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may send an email to info@klygoapp.app</p>
